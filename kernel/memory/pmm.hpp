 ...
 */
constexpr usize pmmChunkSize = 0x1000;
/**
...
[[using gnu: malloc,
    ...
    alloc_size(1),
    aligned(gx::pmmChunkSize)]] void*
page_alloc_z(usize pageCount = 1);
